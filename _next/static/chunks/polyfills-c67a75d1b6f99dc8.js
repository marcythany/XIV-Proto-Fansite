!(function () {
	...
	var Xt =
			...
			function (t, e) {
				var r;
				return (
					null !== t ? (($t.prototype = j(t)), (r = new $t()), ($t.prototype = null), (r[Gt] = t)) : (r = Ht()),
					void 0 === e ? r : Wt(r, e)
				);
			},
		Yt = qt("unscopables"),
		...
		{target: "Array", proto: !0},
		{
			flatMap: function (t) {
				var e,
					...
					n = ft(r.length);
				return (
					Zt(t), ((e = ie(r, 0)).length = Ee(e, r, r, n, 0, 1, t, arguments.length > 1 ? arguments[1] : void 0)), e
				);
			},
		},
	),
					...
					u = function (t, e, r) {
						...
						return (
							c
								? (c.value = r)
								: ((u.last = c =
										{index: (o = Kr(e, !0)), key: e, value: r, previous: (n = u.last), next: void 0, removed: !1}),
								  u.first || (u.first = c),
								  n && (n.next = c),
								  i ? u.size++ : t.size++,
								  "F" !== o && (u.index[o] = c)),
				...
				[
					...
					function (t, o) {
						...
						var a = j(t),
							...
							f = new s(
								Ji ? a : "^(?:" + a.source + ")",
								(a.ignoreCase ? "i" : "") + (a.multiline ? "m" : "") + (a.unicode ? "u" : "") + (Ji ? "y" : "g"),
							),
							l = void 0 === o ? Yi : o >>> 0;
						if (0 === l) return [];
	...
	var yu =
		...
		bu = function (t) {
			return function (e, r, n) {
				...
				return c <= u || "" == s
					? a
					: ((i = yu.call(s, mu((o = c - u) / s.length))).length > o && (i = i.slice(0, o)), t ? a + i : i + a);
			};
		},
	...
	var bs,
				...
				switch (((i = o[f]), c)) {
					...
					case uc:
						if (i && (Us.test(i) || "+" == i || "-" == i || "." == i)) l += i.toLowerCase();
							...
							if (
								r &&
								(Zs(t) != w(Qs, l) || ("file" == l && (tc(t) || null !== t.port)) || ("file" == t.scheme && !t.host))
							)
								return;
					...
					case Oc:
						r || "#" != i
							? i != bs && ("'" == i && Zs(t) ? (t.query += "%27") : (t.query += "#" == i ? "%23" : Js(i, Vs)))
							: ((t.fragment = ""), (c = Rc));
						break;
					case Rc:
		...
		Tc = function () {
			...
			return (
				null !== o
					? ((c += "//"), tc(t) && (c += r + (n ? ":" + n : "") + "@"), (c += $s(o)), null !== i && (c += ":" + i))
					: "file" == e && (c += "//"),
	...
	var Rf,
		...
		el = function (t, e, r) {
			var o, i;
			Xf
				? (((o = Wf.createEvent("Event")).promise = e), (o.reason = r), o.initEvent(t, !1, !0), n.dispatchEvent(o))
